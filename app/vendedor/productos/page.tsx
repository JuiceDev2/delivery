...
export default function ProductosPage() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-10">
      ...
      <form onSubmit={crearProducto} className="mt-6 space-y-3 rounded-lg border border-neutral-200 p-4">
        <input
        ...
        <div className="flex gap-3">
          <input
            type="number"
            step="0.01"
            className="w-1/2 rounded-lg border border-neutral-300 px-4 py-2.5"
            placeholder="Precio"
            value={form.precio}
